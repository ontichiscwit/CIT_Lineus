...
public class StatVO extends CustVO implements Serializable {
	...
	private String c_veterans_yn = "";
	private String c_military_yn = "";	
	...
	public String getC_veterans_yn() {
		return c_veterans_yn;
	}
	public void setC_veterans_yn(String c_veterans_yn) {
		this.c_veterans_yn = c_veterans_yn;
	}
	public String getC_military_yn() {
		return c_military_yn;
	}
	public void setC_military_yn(String c_military_yn) {
		this.c_military_yn = c_military_yn;
	}			
