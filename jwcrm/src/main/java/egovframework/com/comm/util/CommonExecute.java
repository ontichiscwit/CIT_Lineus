...
public class CommonExecute {
	...
	public static void returnJsonString( HttpServletResponse response , String string) throws Exception {
		String res_data = "" ; 
		try{
			//ObjectMapper om = new ObjectMapper() ;
			//res_data = om.writeValueAsString(returnMap) ; 
...
//			}
			...
			if("notice".equals(path[2]) || "faq".equals(path[2]) || "down".equals(path[2])) {
