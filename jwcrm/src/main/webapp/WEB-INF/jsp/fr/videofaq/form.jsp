				...
				if(resultVO != null){
					...
					if (attachList != null && attachList.length > 0) {
						...
						for(var i = 0 ; i < attachList.length ; i++){
							...
							if(datas.attach_save_nm.includes('.mp4')){		
								pathStr += '<br><video width="800px" height="500px" src="' +datas.attach_path + datas.attach_save_nm+ '" controls muted type="video/mp4"></video><br>';
							}
						}
						$('#formWrap').append(fileStr) ; 
						$('#content').html(common.nvl(info.content,''));
						$('#content').append(pathStr);
					}
				}
			}
		}) ; 	
