...
<script type="text/javascript">
	...
	function setBoardList(data) {
		...
		if(resultList != null && resultList.length > 0){
			...
			commonTable.notData(6 , '조회된 데이터가 없습니다.' , 'faq_list') ;
			$("#pagination").html('');
		}
	}
...
<div id="jw_contents">
	<div class="tit_wrap">
		<h2 class="tit_ico_dfaq">FAQ(마약류보고)<span class="txt_tit_right">자주 찾는 질문이나 정보를 확인하세요. </span></h2>
		<div class="location">
			<a href="/fr/main/list.do" class="home">Home</a>
			<a href="/fr/drugfaq/list.do" class="depth"><span class="here">FAQ(마약류보고)</span></a>
		</div>
	</div>
