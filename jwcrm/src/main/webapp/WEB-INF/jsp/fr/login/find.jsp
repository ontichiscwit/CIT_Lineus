		...
		<table class="vType_line mgb20">
			...
			<tbody>
				<tr>
					...
					<td><input type="password" id="pass" title="변경 비밀번호 입력" class="w190" maxlength="8"/></td>
				</tr>
				<tr>
					<th scope="row">비밀번호 재입력</th>
					<td><input type="password" id="pass_confirm" title="비밀번호 재입력" class="w190" maxlength="8"/></td>
				</tr>
			</tbody>
		</table>
		<div class="btn_wrap">
