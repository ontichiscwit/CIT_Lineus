...
<script type="text/javascript">
	...
	function fileDownload(){
	    ...
	    popUrl = "http://sense.cwit.co.kr:8092/resourceManager/setupMngt/launcherSetup.do?hosNo=" + hosNo;
		popOption = "width=750, height=530, status=yes,resizeable=yes,scrollbars=yes ,left="+ popupX + ", top= "+ popupY + ", screenX="+ popupX + ", screenY= "+ popupY;
...
<div id="jw_contents">
	...
	<div class="download_upper">
		...
		<!--<div class="example">
			예 "7020(with ISE)", "7600(with ISE, ID)",  "Iricell3000”, "SINNOWA"
		</div>-->
	 </div>
	<button class="btn_line_blue mgb10" onclick="fileDownload();" style="width:150px">*런쳐설치파일(자동배포처)</button>
