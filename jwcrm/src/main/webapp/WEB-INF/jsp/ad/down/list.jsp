...
<script type="text/javascript">
	...
	function setBoardList(data) {
		...
		if(resultList != null && resultList.length > 0){
			for(var i = 0 ; i < resultList.length ; i++){
				...
				var reg_id = jQuery.trim(common.nvl(resultList.reg_id, '')).toUpperCase();
			...
			commonTable.notData(7 , '조회된 데이터가 없습니다.' , 'down_list') ;
			$("#pagination").html('');
		}
	}
	...
	function goDel() {
		...
		var total_seq = '';
		$("#down_list input[type=checkbox]").each(function(){
			if ($(this).is(':checked')) {
	...
	function procReturn(flag , msg){
		alert(msg) ;
		if(flag == "success") location.href='/ad/down/list.do' ; 
	}
</script>
...
<div class="tit_wrap">
	<h2 class="tit_ico_download">다운로드 관리<span class="tit_depth no_arrow mgl10 mgt8">검색 조건을 선택해 주세요.</span></h2>
	<div class="location">
		<a href="/ad/main/list.do" class="home">Home</a>
		<a href="#" class="depth">게시판 관리</a>
		<a href="/ad/down/list.do" class="depth"><span class="here">다운로드 관리</span></a>
	</div>
</div>
<!-- search -->
<table class="sType mgb20">
	<caption>다운로드 검색</caption>
	<colgroup>
