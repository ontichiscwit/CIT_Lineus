...
<ul class="tab_dashboard list2 mgt30 mgb30">
	...
	<li id="Firstli2"><a href="javascript:firstTab('');">거래처 현황</a></li>
	<li id="Firstli3" class="active"><a href="javascript:firstTab('1');">A/S</a></li>
...
<div class="floatWrap mgb20">
	<div class="w485 floatL">
		...
		<div class="db-greybox">
			<ul class="list4">
				<li onclick="getAsCustList('FLAG1','my')" style="cursor:pointer;"><p>접수</p><p class="num_db" id="top2_1">0</p></li>
				<li onclick="getAsCustList('FLAG2','my')" style="cursor:pointer;"><p>처리중</p><p class="num_db" id="top2_2">0</p></li>
				<li onclick="getAsCustList('FLAG3','my')" style="cursor:pointer;"><p>처리완료</p><p class="num_db colorYellow" id="top2_3">0</p></li>
				<li onclick="getAsCustList('FLAG4','my')" style="cursor:pointer;"><p>지연</p><p class="num_db colorRed" id="top2_4">0</p></li>
			</ul>
		</div>
	</div>
	<div class="w485 floatR">
		...
		<div class="db-greybox">
			<ul class="list4">
				...
				<li onclick="getAsCustList('FLAG2','team')" style="cursor:pointer;"><p>처리중</p><p class="num_db" id="top3_2">0</p></li>
				<li onclick="getAsCustList('FLAG3','team')" style="cursor:pointer;"><p>처리완료</p><p class="num_db colorYellow" id="top3_3">0</p></li>
				<li onclick="getAsCustList('FLAG4','team')" style="cursor:pointer;"><p>지연</p><p class="num_db colorRed" id="top3_4">0</p></li>
			</ul>
		</div>
	</div>
</div>
