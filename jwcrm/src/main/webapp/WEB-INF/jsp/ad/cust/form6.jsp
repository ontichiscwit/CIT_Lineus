...
<script type="text/javascript">
	...
	function addDocRow(){
		...
		str += '<td><button class="btn_line_gray"  onclick="delRow(this);">삭제</button></td>';
		str += '</tr>';
...
<ul class="tab_line list7 mgb20">
	...
	<li class="active"><a href="javascript:moveTab('6');">문서관리</a></li>
</ul>
	...
	<div class="box_layer layer_sms" style="height: 540px; width: 1000px; margin-top: -300px; margin-left:-500px;">
		...
		<div class="layer_contents" style="padding-top: 20px; overflow-y:visible;">
			...
			<table class="hType mgb10">
				...
				<tbody style="overflow-x:auto;max-height:100px" id="addDocTbBody">
				</tbody>
			</table>
