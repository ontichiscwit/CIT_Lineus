...
<script type="text/javascript">
	...
	function procReturn(flag , msg){
		alert(msg) ;
		if(flag == "success") location.href='/ad/drugfaq/list.do' ; 
	}
</script>
...
<div class="tit_wrap">
	<h2 class="tit_ico_dfaq">FAQ(마약류보고) 관리<span class="tit_depth no_arrow mgl10 mgt8">검색 조건을 선택해 주세요.</span></h2>
	<div class="location">
		<a href="/ad/main/list.do" class="home">Home</a>
		<a href="#" class="depth">게시판 관리</a>
		<a href="/ad/drugfaq/list.do" class="depth"><span class="here">FAQ(마약류보고) 관리</span></a>
	</div>
</div>
<!-- search -->
<table class="sType mgb20">
	<caption>FAQ(마약류보고) 검색</caption>
	<colgroup>
