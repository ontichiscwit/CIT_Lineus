...
// 		console.log(exlDataList);
	...
	function setCurrentDay(frm){
		var cuDate = new Date();
		var toDay = new Date(cuDate.getFullYear(),cuDate.getMonth(), cuDate.getDate() );
		console.log(toDay);
		$( "#search_start" ).val($.datepicker.formatDate('yy/mm/dd', toDay))
		$( "#search_end" ).val($.datepicker.formatDate('yy/mm/dd', toDay))
	}
	...
	<table class="sType mgb10">
		...
		<tr>
			...
			<td>
			    ...
			    <input type="radio" class="mgl10 mgr5" name="setMonth" id="set_today" onclick="setCurrentDay(this.form)">현재일
		...
		<tr>
			...
			<td>
			    ...
			    <input type="radio" class="mgl10 mgr5" name="search_type" id="request_type" value="request_type" >문의유형
			    <input type="radio" class="mgl10 mgr5" name="search_type" id="service_cate" value="service_cate" >시스템유형
