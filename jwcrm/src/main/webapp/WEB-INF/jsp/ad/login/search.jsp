...
<div class="tit_wrap_admin">
	<div class="innerWrap">
		<h2>비밀번호 찾기</h2>
		<span>
			회원가입 시, 등록하신 정보를 입력해 주세요. 등록된 정보와 일치하면 비밀번호를 알려드립니다.
		</span>
	</div>
</div>
...
<form name="procFrm" id="procFrm" method="post">
	...
	<div id="jw_contents">
		...
		<table class="vType_line mgb20">
			...
			<tbody>
				...
				<tr>
					...
					<td><input type="text" id="emp_nm" name="emp_nm" title="사용자 이름 입력" class="w190" /></td>
				</tr>
				<tr>
					<th scope="row">이메일</th>
					<td>
		...
		<div class="btn_wrap">
			<div class="floatR">
				<button type="button" class="btn_ico_search" id="btnSearch1" onclick="goProc();"><span>비밀번호 찾기</span></button>
			...
			<table class="vType_line mgb20">
				...
				<tbody>
					<tr>
						...
						<td><input type="password" id="pass" name="pass" title="변경 비밀번호 입력" class="w190" /></td>
					</tr>
					<tr>
						<th scope="row">비밀번호 재입력</th>
						<td><input type="password" id="pass_confirm" name="pass_confirm" title="비밀번호 재입력" class="w190" /></td>
					</tr>
				</tbody>
			</table>
			<div class="btn_wrap">
