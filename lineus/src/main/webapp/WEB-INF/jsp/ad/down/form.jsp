...
<script type="text/javascript">
	...
	function goSubmit() {
		...
		if (confirm("작성된 정보로 다운로드를 등록하시겠습니까?")) {	
...
<div class="tit_wrap">
	...
	<h2 class="tit_ico_download">다운로드관리</h2>
	
	<div class="location">
		<a href="/ad/main/list.do" class="home">Home</a>
		<a href="#" class="depth">게시판관리</a>
		<a href="/ad/down/list.do" class="depth">
		<span class="here">다운로드관리</span>
		</a>
	</div>
