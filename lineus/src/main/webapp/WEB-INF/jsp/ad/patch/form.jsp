...
<script type="text/javascript">
	...
	function listGo() {
		...
		f.method="post";
		f.target = "";
		f.action="/ad/patch/list.do";
		f.submit();
	}
	
</script>
<form id="frmNotice" name="frmNotice" method="post" enctype="multipart/form-data">
<input type="hidden" name="pageGubun" id="pageGubun" value="patch" />
...
<div class="tit_wrap">
	...
	<h2 class="tit_ico_patch">패치노트</h2>
	
	<div class="location">
		<a href="/ad/main/list.do" class="home">Home</a>
		<a href="#" class="depth">게시판관리</a>
		<a href="/ad/patch/list.do" class="depth">
		<span class="here">패치노트</span>
		</a>
	</div>
