...
<script type="text/javascript">
	...
	$(document).ready(function(){
		commonCode.getCodeList('COMMON' , 'CD04' , 'search_type1') ; 		/**	계정상태		*/
	...
	function getEmpList(data){
		...
		if(resultList != null && resultList.length > 0){
			...
			commonTable.notData(10 , '조회된 정보가 없습니다.' , 'listTbody') ; 
		}
	}
...
<table class="sType mgb10">
	...
	<tr>
		...
		<td>
			<input type="text" class="w640 mgr5" id="search_text" name="search_text" title="통합 검색 키워드 입력" placeholder="직원명/거래처이름/부서명/팀명/직책/이메일/전화번호">
