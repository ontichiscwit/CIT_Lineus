...
<script type="text/javascript">
	...
	function goSecond(){
		...
		for(var i = 1 ; i <= 3 ; i++){
			if($('#Thirdli' + i).hasClass("active"))	third = i  ;/* 탭종류 */
		}	
	...
	function setTab1SolutionRightData(data){
			...
			if (resultData.length > 0) {
				...
				commonTable.notData(6, '데이터가 없습니다.', 'setTab1SolutionRightData');
			}
			calChange();
	...
	function makeMidInfo1(data){
		...
		if(third == "1"){
			var a1=0,a2=0,a3=0,a4=0,a5=0,a6=0,b1=0,b2=0,b3=0,b4=0,b5=0,b6=0,b7=0;
			if(onticHisArr != null){
	...
	function drawTab1LeftList(chk){
		if (tab1LeftListData == null) return;
	...
	function getAsAnalList(){
		...
		for(var i = 1 ; i <= 3 ; i++){
			if($('#Thirdli' + i).hasClass("active"))	thirdFlag = i  ;
		}	
...
// 		if (flag == 'c1'){
// 			for (var i=0; i < onticSmsArr.length;i++){
// 				seqStr += ",'" + onticSmsArr[i].seq + "'"; 
// 			}
// 		}else{
			for (var i=0; i < onticSmsArr.length;i++){
				if (flag == 'c1' || onticSmsArr[i][flag] != 0) seqStr += ",'" + onticSmsArr[i].seq + "'"; 
			}	
// 		}
...
<form name="listFrm" id="listFrm" method="post" onsubmit="return false;">
	...
	<input type="hidden" name="secondFlag" value="1" />
</form>
<ul class="tab_dashboard list3 mgt30 mgb30">
	<li id="Firstli1" class="active"><a href="javascript:firstTab('');">거래처 현황</a></li><!-- 활성시 current -->
...
<ul class="list5 db-list mgb20" style="width:calc(100% + 8px)">
	...
	<li id="Secondli5" class="pdr8"  onclick="javascript:secondTab('5');" style="cursor:pointer;">
		<div class="db-greybox">요양/기타<span class="num_db pdl8" id="top5">0</span></div>
	</li>
</ul>
...
<div id="Thirddiv1">
	<div class="tit_wrap small">
		...
		<button type="button" class="btn_ico_search mgr5" onclick=""><span>HIS</span></button>
		<button type="button" class="btn_ico_search mgr5" onclick=""><span>SMS</span></button>
	</div>
	
	<ul class="pro_arrow light mgb5">
		<li class="w100 current">무상</li><!-- 활성시 current -->
		<li class="w380">유상전환</li>
		<li class="w113">유상</li>
		<li class="w407">계약갱신<!-- (자동갱신대상 제외) --></li>
	</ul>
	
	<div class="floatWrap mgb20">
		<div class="db-greybox blue w100 mgr5 floatL">
			<p>무상</p><ul><li class="num_db" id="a1" onclick="javascript:goHisCustList('a1');" style="cursor:pointer;">0</li></ul>
		</div>
		<div class="db-greybox blue w150 mgr-1 floatL">
			...
			<ul class="list2">
				...
				<li class="num_db" onclick="javascript:goHisCustList('a3');" style="cursor:pointer;"><span id="a3">0</span><p class="small">(1개월 미만)</p></li>
			</ul>
		</div>
		<div class="db-greybox blue w225 mgr5 floatL">
			<p class="colorRed">유상 전환 지연</p>
			<ul class="list3">
				<li class="num_db" onclick="javascript:goHisCustList('a4');" style="cursor:pointer;"><span id="a4">0</span><p class="small">(1개월 이내)</p></li>
				<li class="num_db" onclick="javascript:goHisCustList('a5');" style="cursor:pointer;"><span id="a5">0</span><p class="small">(1~2개월)</p></li>
				<li class="num_db" onclick="javascript:goHisCustList('a6');" style="cursor:pointer;"><span id="a6">0</span><p class="small">(3개월 이상)</p></li>
			</ul>
		</div>
		
		<div class="db-greybox blue w109 mgr5 floatL">
			<p>유상</p><ul><li class="num_db" id="b1" onclick="javascript:goHisCustList('b1');" style="cursor:pointer;">0</li></ul>
		</div>
		<div class="db-greybox blue w201 mgr-1 floatL">
			<p>갱신대상(자동갱신 제외)</p>
			<ul class="list3">
				<li class="num_db" onclick="javascript:goHisCustList('b2');" style="cursor:pointer;"><span id="b2">0</span><p class="small">(2개월미만)</p></li>
				<li class="num_db" onclick="javascript:goHisCustList('b3');" style="cursor:pointer;"><span id="b3">0</span><p class="small">(1개월미만)</p></li>
				<li class="num_db" onclick="javascript:goHisCustList('b4');" style="cursor:pointer;"><span id="b4">0</span><p class="small">(갱신지연)</p></li>
			</ul>
		</div>
		<div class="db-greybox blue w202 floatL">
			...
			<ul class="list3">
				...
				<li class="num_db" onclick="javascript:goHisCustList('b7');" style="cursor:pointer;"><span id="b7">0</span><p class="small">(5년 이상)</p></li>
			</ul>
		</div>
	</div>
...
<div id="Thirddiv3" style="display:none;">
	...
	<div class="floatWrap">
		<div class="floatL w490 mgr20">
			<div class="tit_wrap small">
				<h3 class="tit_ico_notice">매출순위</h3>
