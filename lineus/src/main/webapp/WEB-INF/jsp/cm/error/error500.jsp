...
<div class="wrap-error" style="text-align: center; display: table; margin: 100px auto;">
    <img src="/images/ico_caution.png" alt="">
    <p style="font-size: 36px; font-weight: 700; line-height: 1.2em; letter-spacing: -0.05em; margin: 50px 0 20px;">죄송합니다.<br>오류가 발생했습니다.</p>
    <p style="font-size: 14px; color: #666; font-weight: 700;">재시도 후 같은 문제가 발생 시 아래 담당자에게 문의해주시기 바랍니다.<br><br>&nbsp;&nbsp;&nbsp;-1차 담당자 : 김규민 (TEL : 070-7707-5409)<br>-2차 담당자 : 김종호 (TEL : 02-801-1018) <br>-3차 담당자 : 김경아 (TEL : 02-801-1300)</p>
