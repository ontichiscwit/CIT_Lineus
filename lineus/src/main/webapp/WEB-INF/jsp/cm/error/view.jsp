...
<div class="wrap-error" style="text-align: center; display: table; margin: 100px auto;">
    ...
    <p style="font-size: 36px; font-weight: 700; line-height: 1.2em; letter-spacing: -0.05em; margin: 50px 0 20px;">죄송합니다.<br>현재 페이지를 이용하실 권한이 없습니다.</p>
    <p style="font-size: 14px; color: #666; font-weight: 700;">시스템 관리자에게 문의 하세요.</p>
