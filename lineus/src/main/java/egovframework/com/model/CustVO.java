...
public class CustVO extends PagingVO implements Serializable {
	...
	private String charger_no ="";
	private String as_approval_yn_nm ="";
	...
	private String operate_system_name ="";
	...
	public String getAs_approval_yn_nm() {
		return as_approval_yn_nm;
	}

	public void setAs_approval_yn_nm(String as_approval_yn_nm) {
		this.as_approval_yn_nm = as_approval_yn_nm;
	}
	...
	public void setGetDept2_nm(String dept2_nm) {
		this.dept2_nm = dept2_nm;
	}
	...
	public String getOperate_system_name() {
		return operate_system_name;
	}

	public void setOperate_system_name(String operate_system_name) {
		this.operate_system_name = operate_system_name;
	}
